...
# timeslots
with open("timeslots.csv", mode ='r') as file:
...
# days list
weekdays = []
with open("weekdays.csv", mode ='r') as file:
...
# class list
classes = []
with open("class_list.csv", mode ='r') as file:
    csvFile = csv.DictReader(file)
    for lines in csvFile:
...
with open("student_classes.csv", mode ='r') as file:
    dictR = csv.DictReader(file)
    for row in dictR:
...
# teacher list
teacher_list = []
with open("teacher_list.csv", mode ='r') as file:
    csvFile = csv.DictReader(file)
    for lines in csvFile:
...
with open("teacher_classes.csv", mode ='r') as file:
    dictR = csv.DictReader(file)
    for row in dictR:
...
# lessons required
lessons_needed = {}
with open("lessons_required.csv", mode ='r') as file:
    dictR = csv.DictReader(file)
    for row in dictR:
